...
//--------------------------------------------------------------------------------------------------
q3Mat3::q3Mat3( q3r32 a, q3r32 b, q3r32 c, q3r32 d, q3r32 e, q3r32 f, q3r32 g, q3r32 h, q3r32 i )
	: ex( a, b, c )
	, ey( d, e, f )
	, ez( g, h, i )
{
...
//--------------------------------------------------------------------------------------------------
void q3Mat3::Set( q3r32 a, q3r32 b, q3r32 c, q3r32 d, q3r32 e, q3r32 f, q3r32 g, q3r32 h, q3r32 i )
{
	ex.Set( a, b, c );
	ey.Set( d, e, f );
	ez.Set( g, h, i );
...
//--------------------------------------------------------------------------------------------------
void q3Mat3::Set( const q3Vec3& axis, q3r32 angle )
{
	q3r32 s = std::sin( angle );
	q3r32 c = std::cos( angle );
	q3r32 x = axis.x;
	q3r32 y = axis.y;
	q3r32 z = axis.z;
	q3r32 xy = x * y;
...
//--------------------------------------------------------------------------------------------------
q3Mat3& q3Mat3::operator*=( q3r32 f )
{
	ex *= f;
	ey *= f;
	ez *= f;
...
//--------------------------------------------------------------------------------------------------
q3Vec3& q3Mat3::operator[]( q3u32 index )
{
	switch ( index )
	{
	case 0:
...
//--------------------------------------------------------------------------------------------------
const q3Vec3& q3Mat3::operator[]( q3u32 index ) const
{
	switch ( index )
	{
	case 0:
...
//--------------------------------------------------------------------------------------------------
const q3Mat3 q3Mat3::operator*( q3r32 f ) const
{
