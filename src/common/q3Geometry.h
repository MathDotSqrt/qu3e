...
struct q3RaycastData
{
	...
	q3r32 t;			// Time specifying ray endpoint

	q3r32 toi;		// Solved time of impact
	q3Vec3 normal;	// Surface normal at impact

	void Set( const q3Vec3& startPoint, const q3Vec3& direction, q3r32 endPointTime );
