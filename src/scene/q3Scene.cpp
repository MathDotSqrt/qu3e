...
// q3Scene
//--------------------------------------------------------------------------------------------------
q3Scene::q3Scene( q3r32 dt, const q3Vec3& gravity, q3i32 iterations )
...
void q3Scene::Step( )
{
	...
	for ( q3Body* seed = m_bodyList; seed; seed = seed->m_next )
	{
		...
		for ( q3i32 i = 0; i < island.m_bodyCount; i++ )
		{
...
//--------------------------------------------------------------------------------------------------
void q3Scene::SetIterations( q3i32 iterations )
{
